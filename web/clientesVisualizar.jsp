<%-- 
    ...
    Created on : 14 de dez. de 2022, 13:11:21
    Author     : jeffe
--%>

<%-- 
    Document   : PortalJsp
    Created on : 28 de nov. de 2022, 20:10:03
    Author     : jeffe
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ taglib uri='http://java.sun.com/jsp/jstl/core' prefix='c'%>
<%@page import="com.ufpr.tads.web2.beans.LoginBean, com.ufpr.tads.web2.beans.Cliente, java.util.ArrayList, com.ufpr.tads.web2.beans.ConfigBean"%>
<!DOCTYPE html>
