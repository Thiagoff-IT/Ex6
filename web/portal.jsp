...
<%@page import="com.ufpr.tads.web2.beans.LoginBean, com.ufpr.tads.web2.beans.Usuario, java.util.ArrayList, com.ufpr.tads.web2.dao.UsuarioDAO, com.ufpr.tads.web2.beans.ConfigBean"%>
<!DOCTYPE html>
